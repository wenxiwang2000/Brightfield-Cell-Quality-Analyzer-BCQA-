Hi Nice to meet you, here is how to use AI segmention tool to training brightfield cell thickness qutification based on this as a stander to show cell quality:
example input and output, we adjust the parameter to train the thresholding algorithm(Otsu) adjust it's parameter, and after manual mark the auto put become more and more efficient:
<img width="397" height="310" alt="image" src="https://github.com/user-attachments/assets/83c04034-f2d2-4681-8e7a-bbd75637a9d6" />
<img width="397" height="310" alt="image" src="https://github.com/user-attachments/assets/d4c05345-bb26-444d-baaa-3bb0e6859342" />

here is the inteface of the software, using streamlit*


<img width="1916" height="948" alt="image" src="https://github.com/user-attachments/assets/c704d699-3f01-4e02-bd7a-ea023d23e3b7" />



<img width="1537" height="848" alt="image" src="https://github.com/user-attachments/assets/038f8d44-7608-4f05-903e-e83bbe51c26d" />
